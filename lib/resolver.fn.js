const {multiple_power_var, default: Parser} = require('./Parser.class.js');
const { divide, isInt, log } = require('./functions.js');

function hasVariable(parse) {
